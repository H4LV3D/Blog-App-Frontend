    ...
    <>
      <MaxWidthProvider>
        <div className="md:mb-[20vh]  ">
          <div className="h-[12vh] w-full flex space-x-6 items-center">
                ...
                <div className="">
                  ...
                  <div className="grid grid-cols-1 gap-3 mt-4 pr-6">
                    {stats.map((item) => (
                      <div
                        key={item.title}
                        className="flex items-center justify-between border dark:border-neutral-700 p-3 rounded-lg hover:border-black cursor-pointer group"
                      >
